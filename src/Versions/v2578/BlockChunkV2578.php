...
namespace Aternos\Hawk\Versions\v2578;
...
class BlockChunkV2578 extends BlockChunkV2567
{
    /**
    ...
    {
        return SectionV2578::newFromTag($tag, $coordinates, $version);
    }
    ...
    {
        return SectionV2578::newEmpty($coordinates, $version);
    }
}