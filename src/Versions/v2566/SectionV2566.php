...
class SectionV2566 extends Section
{
    ...
    {
        return DataV2566::new($dataBlocks);
    }
    ...
    {
        return DataV2566::newFromTag($tag->getLongArray($section->dataTagName), $section->palette, $section->version, $sectionY);
    }
